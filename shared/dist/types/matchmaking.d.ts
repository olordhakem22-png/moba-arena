...
export type DraftPhase = 'ban_start' | 'blue_ban_1' | 'red_ban_1' | 'blue_ban_2' | 'red_ban_2' | 'blue_ban_3' | 'red_ban_3' | 'pick_start' | 'blue_pick_1' | 'red_pick_1' | 'red_pick_2' | 'blue_pick_2' | 'blue_pick_3' | 'red_pick_3' | 'red_pick_4' | 'blue_pick_4' | 'blue_pick_5' | 'red_pick_5' | 'complete' | 'timeout';
...
export declare const RANK_THRESHOLDS: Record<Rank, number>;
