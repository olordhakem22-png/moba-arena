import type { ChampionStats, Role } from './champion.js';
...
export type GamePhase = 'loading' | 'champion-select' | 'pre-game' | 'countdown' | 'playing' | 'paused' | 'end';
...
export type TerrainType = 'plain' | 'wall' | 'water' | 'cliff' | 'bush' | 'path' | 'tower-range' | 'nexus';
...
export type ZoneType = 'base' | 'lane' | 'jungle' | 'river' | 'objective' | 'shop';
...
export type ObjectiveType = 'dragon' | 'rift-herald' | 'baron' | 'tower' | 'inhibitor' | 'nexus-tower';
...
export type EventType = 'champion_kill' | 'minion_kill' | 'tower_kill' | 'inhibitor_kill' | 'dragon_kill' | 'baron_kill' | 'herald_kill' | 'level_up' | 'item_purchase' | 'summoner_spell_used' | 'ability_used' | 'game_start' | 'game_end' | 'first_blood' | 'game_paused' | 'game_resumed';
...
export type InputType = 'move' | 'attack' | 'ability' | 'item' | 'recall' | 'ping' | 'emote';
