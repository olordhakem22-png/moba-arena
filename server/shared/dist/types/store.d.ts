...
export type StoreItemType = 'champion' | 'skin' | 'chroma' | 'ward-skin' | 'emote' | 'icon' | 'bundle';
export type StoreCategory = 'champions' | 'skins' | 'chromas' | 'wards' | 'emotes' | 'icons' | 'bundles';
...
export type ShopItemCategory = 'starter' | 'basic' | 'epic' | 'legendary' | 'boots' | 'consumable' | 'trinket';
